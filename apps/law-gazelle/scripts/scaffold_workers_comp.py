...
_SEED_ATOMS = [
    (
        ...
        "Work-Related Back Injury — Two Herniated Discs",
        "Two back injury (lumbar and mid-back). Onset May 2025 during employment at Trader Joe's (Example Employer Inc.).",
        "NMSA 1978 Workers' Compensation Act",
    ...
    (
        ...
        "Campbell v. Example Employer Inc. (Trader Joe's). New Mexico Workers' Compensation Administration.",
        "WCA 00-00000",
    ...
    (
        ...
        "Surgery consultation scheduled per Shield Email disclosure. Document outcome for support modification (July 1).",
        None,
...
def main() -> int:
    ...
    conn.execute(
        ...
        (
            ...
            "open",
            "New Mexico WCA",
            "Example Employer Inc. (Trader Joe's)",
            "2025-05-01",
